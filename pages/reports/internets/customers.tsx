...
const Customer = () => {
  ...
  const getApi = apiHook({
    key: ['customer-internet'],
    method: 'GET',
    url: `reports/internets/customers?page=${page}&q=${q}&limit=${50}`,
  })?.get
...
export default dynamic(() => Promise.resolve(withAuth(Customer)), {
  ssr: false,
})
